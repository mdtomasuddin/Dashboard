...
use App\Http\Controllers\Web\V1\Settings\FAQ\FAQController;
...
// ! Social Media Links
Route::apiResource('social-links', SocialMediaController::class);
...
Route::post('faq/status/{id}', [FAQController::class, 'status'])->name('faqs.status');
