...
@section('content')
    ...
    <div class="page-header">
        <div class="page-title">
            <nav class="breadcrumb">
                ...
                <a href="{{ route('privacy-policy.index') }}" class="breadcrumb-link">Settings</a>
                <i class="fa-solid fa-chevron-right breadcrumb-separator"></i>
                <span class="breadcrumb-active">Privacy Policy</span>
            </nav>
            <p class="page-description">
                Update the Privacy Policy details below and submit.
            </p>
        </div>
    </div>
    <!--end: Page Header-->
    ...
    <div class="card">
        <div class="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100 dark:border-gray-800">
            ...
            <div class="flex-1">
                <h3 class="text-base font-bold text-gray-800 dark:text-white">Privacy Policy</h3>
                <p class="text-sm text-gray-400 dark:text-gray-500">Manage your Privacy Policy content</p>
            </div>
        </div>

        <form method="POST" action="{{ route('privacy-policy.store') }}" class="form" novalidate="novalidate">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input @error('title') is-invalid @enderror" name="title"
                        id="title" placeholder="Enter title" value="{{ old('title', $privacy_policy->title ?? '') }}">
                    @error('title')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input bg-gray-100 dark:bg-gray-800/50 cursor-not-allowed"
                        id="disabledInput" value="{{ $privacy_policy->slug ?? 'Auto-generated on save' }}" disabled>
                </div>
                <!--end: Slug Field-->
            </div>
