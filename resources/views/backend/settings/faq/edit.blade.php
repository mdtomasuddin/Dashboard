    ...
    <div class="page-header">
        ...
        <div class="page-title">
            <nav class="breadcrumb">
                ...
                <i class="fa-solid fa-chevron-right breadcrumb-separator"></i>
                <span class="breadcrumb-active">Edit FAQ</span>
            </nav>
            <p class="page-description">
                Update FAQ details below. Ensure all required fields are filled before submitting.
            </p>
        </div>
        <!--end: Page Title-->
        <!--begin: Actions-->
        ...
        <form action="{{ route('faqs.update', $faq->id) }}" method="POST">
            ...
            <div class="grid grid-cols-12 gap-5">
                ...
                <div class="col-span-12 flex flex-col gap-1.5">
                    ...
                    <textarea class="form-input @error('answer') is-invalid @enderror" id="summernote" name="answer"
                        placeholder="Enter answer details...">{{ old('answer', $faq->answer) }}</textarea>
                    @error('answer')
                        <span class="input-error">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn-submit">
                    <i class="fa-solid fa-floppy-disk text-xs"></i> <span>Update FAQ</span>
                </button>
            </div>
            <!--end: Form Actions-->
        </form>
