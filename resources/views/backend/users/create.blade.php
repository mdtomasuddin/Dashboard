    ...
    <div class="page-header">
        ...
        <div class="page-title">
            ...
            <p class="page-description">
                Create a new user by filling out the form below. Ensure all required fields are completed before submission.
            </p>
        </div>
        <!--end: Page Title-->
        <!--begin: Actions-->
        ...
        <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-12 gap-5">
                ...
                <div class="col-span-12 flex flex-col gap-1.5">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}"
                        class="form-input @error('email') is-invalid @enderror" placeholder="user@example.com" required>
                    @error('email')
                        <span class="input-error">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn-submit">
                    <i class="fa-solid fa-user-plus text-xs"></i> <span>Create User</span>
                </button>
            </div>
            <!--end: Form Actions-->
        </form>
