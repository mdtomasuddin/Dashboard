...
@section('content')
    ...
    <div
        ...
        <div class="p-5 lg:p-6 border-b border-gray-100 dark:border-gray-800">
            <h3 class="text-lg font-bold text-gray-800 dark:text-white">Edit User</h3>
            <p class="text-sm text-gray-400 dark:text-gray-500 mt-0.5">
                Update the information for <strong
                    class="text-gray-600 dark:text-gray-300">{{ trim($user->first_name . ' ' . ($user->last_name ?? '')) }}</strong>.
            </p>
        </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <div class="w-24 h-24 rounded-full bg-gray-100 dark:bg-gray-800 border-2 border-dashed border-gray-300 dark:border-gray-600 flex items-center justify-center overflow-hidden mb-3 mx-auto md:mx-0">
                            @if($user->avatar)
                                <i id="avatar_icon" class="fa-solid fa-user text-3xl text-gray-400" style="display:none;"></i>
                                <img id="avatar_preview_img" src="{{ asset($user->avatar) }}" class="w-full h-full object-cover" />
                            @else
                        ...
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">JPG, PNG, WebP. Max 2MB. Leave empty to
                            keep current.</p>
                    </div>
                </div>
                <!--end: Avatar Upload-->
                ...
                <div>
                    ...
                    <div class="relative">
                        <div class="w-full h-24 rounded-xl bg-gray-100 dark:bg-gray-800 border-2 border-dashed border-gray-300 dark:border-gray-600 flex items-center justify-center overflow-hidden mb-3">
                            @if($user->cover)
                                <i id="cover_icon" class="fa-solid fa-image text-3xl text-gray-400" style="display:none;"></i>
                                <img id="cover_preview_img" src="{{ asset($user->cover) }}" class="w-full h-full object-cover" />
                            @else
